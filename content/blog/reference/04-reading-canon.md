...
**The agentic-frontier primary sources** · **[E/P — read the standards and lab papers, not the commentary]**
*Teaches:* the ground truth the corpus is now prosecuted against (see reference item 15, the gap analysis). Standards, dated: Linux Foundation A2A (2025-06-23) and AGNTCY (2025-07-29) — agent interop is *federated*, not one gateway; MCP spec 2025-11-25 and the stateless 2026-07-28 release candidate — chokepoints are being engineered out; OAuth Token Exchange RFC 8693 (`act`/`may_act`) and the IETF attenuating-agent-tokens draft (2025) — delegation is a *chain*, attenuated per hop; W3C Verifiable Credentials 2.0 (Recommendation 2025-05-15) with Open Badges 3.0 / CLR 2.0 — where the portable academic record actually converged; Sigstore Rekor / Trillian — the transparency-log pattern that beats a bare hash chain; CloudEvents v1.0.2 — still no actor/purpose/on-behalf-of in core, so those stay custom extensions. Lab findings, dated: OpenAI chain-of-thought monitoring (2025-03-10) and Anthropic reward tampering (2024-06-17) — non-deterministic workers game their own metrics and hide it; DeepMind Frontier Safety Framework v3/3.1 (2025-09-22 / 2026-04-17) — capability-gated autonomy tiers; DORA 2025 — AI lifts throughput, still taxes stability without control systems; METR developer RCT (2025-07-10) — the honest counterweight, experienced devs slower than they predicted.
*Weak where:* half of these are one to two years from stale, and the vendor/consulting layer around them (gateway marketing, consulting "operating model" projections) overstates convergence. Read the primary spec or paper; discard the commentary. Several fabricated arXiv IDs surfaced in search during the gap analysis — verify every identifier before citing.
*How to read:* as the evidence base for the quarterly self-prosecution, not as settled canon. The point of listing them is to have something concrete to be wrong against next quarter.
